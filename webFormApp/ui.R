...
fluidPage(
    ...
    fluidRow(
        ...
        div(id = "form",
            ...
            hr(),
            h3("Input Data"),
            radioButtons("type_of_genome_seq_data", "What type of genome sequencing data are used",
                         c("WES", "WGS", "Gene panels", "Other (please describe)" = "Other")),
            conditionalPanel("input.type_of_genome_seq_data == 'Other'", 
                             textInput("type_of_genome_seq_data_description", "Describe")),
            radioButtons("driver_gene_ID_strategy", "What is the primary strategy of identifying driver genes",
            ...
            radioButtons("method_account_for_cofactors", "Does the method account for cofactors", 
                         c("Sequence trinucleotide content", "Gene expression level", 
                           ...
                           "None")),
            conditionalPanel("input.method_account_for_cofactors == 'Other'", 
            ...
            radioButtons("method_compute_pvals", "Does the method compute p-values",
