    ...
    fluidRow(
        ...
        div(id = "form",
            ...
            radioButtons("scope", "Does the method/publication fit our scope",
                         c("None Selected" = "NA", "Yes", "Maybe", "No")),
            hr(),
            h3("Input Data"),
            ...
            radioButtons("limited_to_subset_of_genes", paste("Is the method limited to a subset of genes ",
                         ...
                         c("None Selected" = "NA", "Yes (please describe)" = "Yes", "No")),
            ...
            radioButtons("pathway_network_analysis", 
                         "Pathway & network analysis of resulting genes", c("None Selected" = "NA", "Yes", "No")),
            ...
            radioButtons("performance_on_rand_input_data_to_eval_FDR", 
                         paste("Performance on randomised input data to ",
                               "evaluate false discovery rate", sep = ""), c("None Selected" = "NA", "Yes", "No")),
            radioButtons("performance_on_rand_subset_of_data_test_robustness", 
                         paste("Perfomance on random subsets of data ",
                               "to test robustness", sep = ""), c("None Selected" = "NA", "Yes", "No")),
            radioButtons("performance_rel_to_other_methods", 
                         paste("Performance relative to other cancer ",
                               "driver discovery methods", sep = ""), c("None Selected" = "NA", "Yes", "No")),
            radioButtons("eval_of_method_params", "Evaluation of method parameters", c("None Selected" = "NA", 
                                                                                       "Yes", "No")),
            radioButtons("eval_of_resulting_pval_distributions", 
                         paste("Evaluation of resulting p-value distributions ",
                               "(quantile-quantile analysis, etc)", sep = ""), c("None Selected" = "NA", "Yes", "No")),
            hr(),
            h3("Data and Code Availability"),
            radioButtons("software_available", "Is the software available", c("None Selected" = "NA", "Yes", "No")),
            radioButtons("source_code_available", "Is the source code available", c("None Selected" = "NA", "Yes","No")),
            radioButtons("datasets_available", "Are the datasets required for the analysis in the paper available",
                         c("None Selected" = "NA", "Yes", "No")),
